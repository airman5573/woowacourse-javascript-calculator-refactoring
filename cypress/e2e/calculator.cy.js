...
describe("구현 결과가 요구사항과 일치해야 한다.", () => {
  ...
  it("2개의 숫자에 대해 덧셈이 가능하다.", () => {
    cy.get(testid`digit1`).click();
    cy.get(testid`digit0`).click();
    cy.get(testid`plus`).click();
    cy.get(testid`digit2`).click();
    cy.get(testid`digit0`).click();
